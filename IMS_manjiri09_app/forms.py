...
from IMS_manjiri09_app.models import Courses, SessionYearModel
...
class AddStudentForm(forms.Form):
    ...
    remark = forms.CharField(label="Remark",max_length=100,widget=forms.TextInput(attrs={"class":"form-control"}),required=False)
